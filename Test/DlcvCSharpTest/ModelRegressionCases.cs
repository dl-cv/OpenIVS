    ...
    internal static class ModelRegressionCases
    {
        ...
        public static readonly List<ModelRegressionCase> Cases = new List<ModelRegressionCase>
        {
            ...
            Case("气球大模型 DVT", "气球-大模型_20260830_010011_120_50_s.dvt", "气球.jpg",
                Sample(Result(0, "气球", 0.9591543078422546, B(77.875, 59.8125, 486.25, 569.625), 219656.0, -100.0, true, true, false, M(486, 569, 219656)))),
            ...
            Case("气球实例分割 Virbox DVT", "气球-实例分割_120_50_v.dvt", "气球.jpg",
                Sample(Result(0, "气球", 0.9990234375, B(56.20000076293945, 46.0, 505.4000244140625, 588.7999877929688), 227775.0, -100.0, true, true, false, M(505, 588, 227775)))),
