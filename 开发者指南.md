# OpenIVS2 新增 PLC 监听类型开发者指南

本文说明如何在 OpenIVS2 中增加一种新的 PLC 监听方式，例如新的 Modbus 传输方式、厂商私有 TCP 协议、Siemens S7、OPC UA 或 EtherNet/IP。
...
| `serial` | `SerialModbusClient` | `manual_trigger` | `MainWindow.StartPlcPolling()` |
