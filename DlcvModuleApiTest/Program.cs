        ...
        static void Main(string[] args)
        {
            ...
            var modules_list = new JArray
            {
                ...
                new JObject
                {
                    ...
                    ["model_path"] = @"C:\Users\Administrator\Desktop\三代目测试目录\ocr\ocr_det.dvt",
                    ["task_type"] = "det",
                    ["threshold"] = 0.5,
                    ["iou_threshold"] = 0.2,
                    ["top_k"] = 1,
                ...
                {
                    ["module_type"] = "model_inference",
                    ["model_path"] = @"C:\Users\Administrator\Desktop\三代目测试目录\ocr\ocr_ocr.dvt",
                    ["task_type"] = "ocr",
                    ["threshold"] = 0.5,
                    ["iou_threshold"] = 0.2,
                    ["top_k"] = 1,
            ...
            string testImg = @"C:\Users\Administrator\Desktop\三代目测试目录\ocr\ocr.jpg"; // 替换为你的测试图片
            try
            {
