...
namespace OpenIVSWPF.Managers
{
    ...
    /// Modbus初始化和通信管理类
    /// </summary>
    public class ModbusInitializer
    {
        ...
        public ModbusInitializer(Action<string> statusCallback, Action<string> deviceStatusCallback, Action<float> positionUpdateCallback)
        {
